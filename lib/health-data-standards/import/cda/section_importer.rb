        ...
        def extract_negation(parent_element, entry)
          ...
          unless negation_indicator.nil?
            ...
            if entry.negation_ind
              ...
              # The above is cited as being necessary for immunizations, so keeping it for now, but the bellow
              # makes waaaaaaay more sense as far as coding goes.
              if negation_reason_element.nil?
